<%@ Page Title="" Language="C#" MasterPageFile="~/PMTZ-Admin/Site.master" AutoEventWireup="True" CodeBehind="Photographers.aspx.cs" Inherits="MapIt.Web.Admin.Photographers" %>
        ...
        <ContentTemplate>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-xs-12 text-right">
                                <div class="form-group">
                                    <asp:Button ID="btnAddNew" runat="server" Text="Add new Photographer" CssClass="btn btn-primary"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:Button ID="btnPrint" runat="server" CssClass="btn btn-default" CausesValidation="false" Text="Print"
                                    OnClientClick="printContent('div_photographers');" />
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Photographers List</div>
                            <div class="panel-body">
                                <div id="div_photographers" style="display: none;">
                                    ...
                                    <fieldset>
                                        <legend>Photographers List</legend>
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <div class="form-group">
                                                    <label>
                                    ...
                                    <asp:GridView runat="server" ID="gvPhotographersExcel" ShowFooter="false" AutoGenerateColumns="false"
                                ...
                                <asp:GridView runat="server" ID="gvPhotographers" CssClass="table"
                                    ShowFooter="false" AutoGenerateColumns="false"
                                    GridLines="None" AllowPaging="false" PagerStyle-Visible="false"
                                    DataKeyField="Id" EmptyDataText="No Data" ShowHeaderWhenEmpty="true"
                                    OnRowCommand="gvPhotographers_RowCommand" AllowSorting="true" OnSorting="gvPhotographers_Sorting">
                                    <SelectedRowStyle BackColor="DarkSlateBlue" ForeColor="GhostWhite" />
                                    <RowStyle VerticalAlign="Middle" />
                                    <AlternatingRowStyle CssClass="alt-table-data" />
                                    <Columns>
            ...
            <asp:Panel ID="pnlRecordDetails" runat="server" Visible="false">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Photographer Details</div>
                            <div class="panel-body">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>
