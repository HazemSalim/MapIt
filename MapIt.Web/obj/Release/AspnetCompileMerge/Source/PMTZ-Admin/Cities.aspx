<%@ Page Title="" Language="C#" MasterPageFile="~/PMTZ-Admin/Site.master" AutoEventWireup="true" CodeBehind="Cities.aspx.cs" Inherits="MapIt.Web.Admin.Cities" %>
    ...
    <asp:UpdatePanel ID="upMain" runat="server">
        <ContentTemplate>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                ...
                                <asp:Button ID="btnSave" runat="server" Text="Add new City" OnClick="btnSave_Click" CssClass="btn btn-primary"
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Cities List</div>
                        <div class="panel-body">
                            <asp:GridView runat="server" ID="gvCities" CssClass="table"
                                ...
                                OnRowCommand="gvCities_RowCommand" AllowSorting="true" OnSorting="gvCities_Sorting">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <a href="Areas?id=<%# Eval("Id") %>" class="grid_button"><i class="fa fa-map-signs" style="font-size: 25px;"></i></a>
