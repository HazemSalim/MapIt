<%@ Page Title="" Language="C#" MasterPageFile="~/PMTZ-Admin/Site.master" AutoEventWireup="true" CodeBehind="Blocks.aspx.cs" Inherits="MapIt.Web.Admin.Blocks" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li><a href="Cities?id=<%:new MapIt.Repository.AreasRepository().GetByKey(this.AreaId).City.CountryId %>">Cities
                    </a></li>
                    <li><a href="Areas?id=<%:new MapIt.Repository.AreasRepository().GetByKey(this.AreaId).CityId %>">Areas
                    </a></li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                ...
                                <asp:Button ID="btnSave" runat="server" Text="Add new Block" OnClick="btnSave_Click" CssClass="btn btn-primary"
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <asp:GridView runat="server" ID="gvBlocks" CssClass="table"
                                ...
                                OnRowCommand="gvBlocks_RowCommand" AllowSorting="true" OnSorting="gvBlocks_Sorting">
