<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Thanks.aspx.cs" Inherits="MapIt.Web.Payment.Thanks" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>MapIt | Thanks Page</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="divcontent" runat="server" style="width: 100%; float: left; padding-top: 0px;">
            <div style="background-color: #f2f2f2; padding-left: 35px; padding-right: 35px; padding-top: 35px; padding-bottom: 50px; width: 770px; margin: 30px auto; border-radius: 15px; -moz-border-radius: 15px; -webkit-border-radius: 15px;">
                ...
                <div style="float: left; text-align: left;">
                    ...
                    <p style="margin-left: 58px; color: #669933;">
                        <b>Your payment is done successfully</b>
                    </p>
        ...
        <p>
            <asp:Button ID="btnShowInv" runat="server" OnClick="btnShowInv_Click" Text="Show Invoice Details" class="btn green"
                Width="225px" Style="float: none; display: inline-block;" />
        </p>
    </form>
</body>
</html>
