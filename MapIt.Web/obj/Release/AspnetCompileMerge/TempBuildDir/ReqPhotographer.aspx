<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True" CodeBehind="ReqPhotographer.aspx.cs" Inherits="MapIt.Web.ReqPhotographer" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title><%= GetGlobalResourceObject("Resource","web_title") %> | <%= GetGlobalResourceObject("Resource","request_photographer") %></title>
</asp:Content>
        ...
        <div class="uk-container ">
            <div class="uk-position-relative">
                ...
                <div class="BodyContainer">
                    <h1 class="uk-heading-line uk-text-left pageTitle"><span><%= GetGlobalResourceObject("Resource","request_photographer") %></span></h1>
