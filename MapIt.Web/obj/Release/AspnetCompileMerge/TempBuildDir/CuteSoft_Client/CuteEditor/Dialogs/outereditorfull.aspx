...
var OxOa288=["postback","Save"];function doClose(){Window_SetDialogReturnValue(window,null);var OxO5172=[];Window_CloseDialog(window);} ;function CuteEditor_OnCommand(editor,Ox4d,Ox4e,Ox4f){if(Ox4d.toLowerCase()==OxOa288[0]&&Ox4f==OxOa288[1]){Window_SetDialogReturnValue(window,'<%= Request.QueryString["f"]%>');} ;} ;
</script>

<asp:Panel runat=server Visible=false id="savedpanel">
<script language="JavaScript" type="text/javascript" >
var OxO5172=[];Window_CloseDialog(window);
</script>
</asp:Panel>