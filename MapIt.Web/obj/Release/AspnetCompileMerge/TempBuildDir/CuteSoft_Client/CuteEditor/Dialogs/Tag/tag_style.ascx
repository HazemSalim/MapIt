...
var OxO6f6a=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxO6f6a[1],true)[OxO6f6a[0]]=function (){if(event[OxO6f6a[2]]){alert(element[OxO6f6a[3]].cssText);} ;} ;
</script>
