<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProFavorites.aspx.cs" Inherits="MapIt.Web.ProFavorites" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title><%= GetGlobalResourceObject("Resource","web_title") %> | <%= GetGlobalResourceObject("Resource","my_favorites_pro") %></title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="upFavoritesPro" runat="server">
        <ContentTemplate>
                        ...
                        <div class="BodyContainer">
                            ...
                            <div class="uk-container ">
                                <div class="uk-child-width-1-3@m uk-grid" uk-sortable="handle: .uk-sortable-handle" uk-grid>
                                    ...
                                    <asp:Repeater ID="rFavPros" runat="server" OnItemCommand="rFavPros_ItemCommand">
                                        <ItemTemplate>
                                            <!-- ***************** start card **************** -->
                                                ...
                                                <div class="uk-card uk-card-default">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="uk-position-bottom-right  sizeSpan" style="padding: 5px;">
                                                            ...
                                                            <asp:LinkButton ID="lnkFav" CommandName="DeleteFav" CommandArgument='<%# Eval("Id") %>' runat="server">
