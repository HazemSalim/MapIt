<%@ Page Title="" Language="C#" MasterPageFile="~/PMTZ-Admin/Site.master" AutoEventWireup="True" CodeBehind="UserBalanceLogs.aspx.cs" Inherits="MapIt.Web.Admin.UserBalanceLogs" %>
        ...
        <ContentTemplate>
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active">User Balance Logs</li>
                </ol>
            </div>
            <!--/.row-->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">User Balance Logs</h1>
                </div>
            </div>
            <!--/.row-->
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:Button ID="btnPrint" runat="server" CssClass="btn btn-default" CausesValidation="false" Text="Print"
                                OnClientClick="printContent('div_userlogs');" />
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div id="div_userlogs" style="display: none;">
                                ...
                                <asp:GridView runat="server" ID="gvLogsExcel" ShowFooter="false" AutoGenerateColumns="false"
                            ...
                            <asp:GridView runat="server" ID="gvLogs" ShowFooter="false" AutoGenerateColumns="false"
                                ...
                                ShowHeaderWhenEmpty="true" AllowSorting="true" OnSorting="gvLogs_Sorting">
                                <SelectedRowStyle BackColor="DarkSlateBlue" ForeColor="GhostWhite" />
                                <RowStyle VerticalAlign="Middle" />
                                <AlternatingRowStyle CssClass="alt-table-data" />
                                <Columns>
