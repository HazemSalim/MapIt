<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Location.aspx.cs" Inherits="MapIt.Web.Admin.Location" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Map It Administration Panel</title>
    <script src="http://maps.googleapis.com/maps/api/js?sensor=false&key=AIzaSyD3wRValWNTNYTUerUltwMlpKzcf0VKtfU&"></script>
        ...
        function initMap() {
            ...
            if (marker == '1') {
                ...
                if (longitude.value == '' || !isNumber(longitude.value) || latitude.value == '' || !isNumber(latitude.value)) {
                    //latitude.value = '30.04447180797392';
                    //longitude.value = '31.235509514808655';
...
<body onload="initMap();">
    <form id="form1" runat="server">
        <div id="map_canvas" style="margin: auto; width: 700px; height: 480px;">
        </div>
    </form>
</body>
</html>
