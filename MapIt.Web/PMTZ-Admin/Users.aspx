                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlSearchSexStatus" runat="server" CssClass="form-control"   AppendDataBoundItems="true">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlSearchActiveStatus" runat="server" CssClass="form-control"   AppendDataBoundItems="true">
                               ...
                               <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlUserTypes" runat="server" CssClass="form-control"  AppendDataBoundItems="true">
                                        <asp:ListItem Text="All User Types" Value=""></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <asp:Label ID="lblSearchUserType" runat="server" CssClass="form-control"></asp:Label>
                                        </div>
                                        <div class="form-group">
                                            <label>
                                                Activation Status
