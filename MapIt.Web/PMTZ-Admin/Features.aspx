<%@ Page Title="" Language="C#" MasterPageFile="~/PMTZ-Admin/Site.master" AutoEventWireup="True" CodeBehind="Features.aspx.cs" Inherits="MapIt.Web.Admin.Features" %>
    ...
    <asp:UpdatePanel ID="upMain" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Feature Details</div>
                        <div class="panel-body">
                            <div class="col-md-6">
                                ...
                                <asp:Button ID="btnSave" runat="server" Text="Add new Feature" OnClick="btnSave_Click" CssClass="btn btn-primary"
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Features List</div>
                        <div class="panel-body">
                            <asp:GridView runat="server" ID="gvFeatures" CssClass="table"
                                ...
                                OnRowCommand="gvFeatures_RowCommand" AllowSorting="true" OnSorting="gvFeatures_Sorting">
