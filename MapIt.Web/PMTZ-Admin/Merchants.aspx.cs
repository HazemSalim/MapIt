    ...
    public partial class Merchants : System.Web.UI.Page
    {
        ...
        public void ClearControls()
        {
            txtFullName.Text = txtCountry.Text = txtCity.Text = txtCode.Text = txtPhone.Text = txtEmail.Text =
                txtCompanyName.Text = txtDetails.Text = string.Empty;
        ...
        void Add()
        {
            try
            {
                ...
                merchantObj.Phone = txtCode.Text + " " + txtPhone.Text;
        ...
        bool SetData(long id)
        {
            try
            {
                ...
                if (merchantObj != null)
                {
                    ...
                    txtDetails.Text = merchantObj.Details;
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                if (gvMerchantsExcel.Rows.Count == 0)
                {
